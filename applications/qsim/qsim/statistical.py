...
class statistical:
    ...
    __AMOUNT_QSIM_REQUESTS = 0
    __AMOUNT_QSIM_RESPONSES = 0
    ...
    @staticmethod
    def inc_qsim_requests():
        with statistical.__resource_locker:
            statistical.__AMOUNT_QSIM_REQUESTS += 1


    @staticmethod
    def inc_qsim_responses():
        with statistical.__resource_locker:
            statistical.__AMOUNT_QSIM_RESPONSES += 1
    ...
    @staticmethod
    def get_qsim_requests():
        with statistical.__resource_locker:
            return statistical.__AMOUNT_QSIM_REQUESTS


    @staticmethod
    def get_qsim_responses():
        with statistical.__resource_locker:
            return statistical.__AMOUNT_QSIM_RESPONSES

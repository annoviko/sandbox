...
class code_block:
    ...
    def __process_command(self, command, argument):
        ...
        if (command == command_type.COMMAND_SEND):
            ...
            os._exit(error_code.ERROR_SCRIPT_UNKNOWN_COMMAND);

...
api_caller = tas_api(db.phone3.accountId, db.phone3.mailboxId)
api_forwarded = tas_api(db.phone2.accountId, db.phone2.mailboxId)

api_admin = tas_api(db.phone1.accountId, db.phone1.mailboxId)

session_id, caller_party_id = api_caller.callout(db.phone3.deviceId, db.phone1.number, assertion=True)
...
print(session_id, callee_forward_party_id)

body = api_forwarded.answer(session_id, callee_forward_party_id, db.phone2.deviceId, assertion=True)
print(body)
